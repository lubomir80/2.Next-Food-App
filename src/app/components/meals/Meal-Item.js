...
export default function MealItem({ title, slug, image, summary, creator }) {
   return (
      <article className="flex flex-col justify-between h-full rounded-md shadow-md shadow-slate-900 overflow-hidden text-text bg-meal animate-loading">
         <header>
         ...
         <div className="flex flex-col justify-between h-full">
            ...
            <div className="p-4 text-right">
               <Link className="inline-block mt-4 py-2 px-4 rounded-lg
                  ...
                  hover:bg-lightOrange hover:shadow-md hover:shadow-slate-800 action:bg-lightOrange 
